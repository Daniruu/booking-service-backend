...
namespace BookingService.Migrations
{
    ...
    [Migration("20241229153116_AddConfirmationCodeAndEmailConfirmedToUser")]
    partial class AddConfirmationCodeAndEmailConfirmedToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookingService.Models.Business", b =>
                {
                            ...
                            b1.OwnsMany("BookingService.Models.TimeSlot", "TimeSlots", b2 =>
                                {
                                    ...
                                    b2.ToTable("Businesss_Schedule_TimeSlots");
                    ...
                    b.OwnsOne("BookingService.Models.BusinessSettings", "Setting", b1 =>
                        {
                            b1.Property<int>("BusinessId")
                                .HasColumnType("integer");
